...
const OptionWheel = ({
  ...
  return (
    <span
      ...
      className={`ml-200 mt-40 absolute z-100 h-[50%] w-[50%] select-none overflow-hidden outline-none [touch-action:none] ${isDragging ? 'cursor-grabbing' : 'cursor-grab'}${className ? ` ${className}` : ''}`}
      style={
        {
