      ...
      <div className="flex flex-col md:flex-row w-full max-w-4xl bg-white rounded-3xl shadow-sm overflow-hidden border border-gray-100">
        ...
        <div className="flex flex-col flex-1 border-t md:border-t-0 md:border-l border-gray-100">
          ...
          <div className="px-6 md:px-8 py-5 md:py-6 border-b border-gray-100 flex items-center flex-wrap gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="flex items-center justify-center w-6 h-6 md:w-8 md:h-8 rounded-full bg-black text-white flex-shrink-0">
                <svg viewBox="0 0 24 24" fill="none" className="w-3 h-3 md:w-4 md:h-4" stroke="white" strokeWidth={3}>
          ...
          <div className="px-6 md:px-8 py-5 md:py-6 border-b border-gray-100 flex-1">
            <p className="text-base md:text-lg font-bold text-black mb-2">Full-stack developer</p>
            <p className="text-sm md:text-base text-gray-500 leading-relaxed max-w-md">
              Building low-latency trading systems on Solana and sharpening execution in live markets.
            </p>
          </div>
          ...
          <div className="px-6 md:px-8 py-5 md:py-6 flex flex-wrap items-center gap-3">
            {/* Contact Me Button */}
            <button className="flex items-center gap-2 bg-black text-white text-xs md:text-sm font-semibold px-5 py-2.5 md:py-3 rounded-full hover:bg-gray-800 transition-colors shadow-sm">
              <svg viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth={2} className="w-3.5 h-3.5 md:w-4 md:h-4">
            ...
            <div className="flex items-center gap-2 md:gap-3">
              {/* GitHub */}
              <a href="#" className="flex items-center justify-center w-10 h-10 md:w-11 md:h-11 rounded-full border border-gray-200 text-gray-500 hover:border-black hover:bg-gray-50 transition-all">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className="w-4.5 h-4.5 md:w-5 md:h-5">
