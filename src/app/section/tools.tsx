export default function Tools() {
    const tools = [{image: "image", heading: "Datafeed", description: "The team invented FlixiVerse to explore characters' worlds and homes like they were real-life film sets. See how they scouted Gwen's apartment to find the perfect blocking and shots to create scenes with emotional impact."},
        ...
        {image: "image", heading: "issuex", description: "Vulture was a “living drawing” — and he required a tool that could keep up with him. Artists used Kismet to work digitally and still give scenes a hand-drawn feel. This gave them precise control over how characters looked and moved."}
    ];
